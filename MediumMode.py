...
# method to get the results for numbered entered
    ...
    def reset_game(self):
        ...
        self.instructions_label.setText("Pick a number between 1 and 100")
